...
- Port ERC1155 to TRC1155. ([#54](https://github.com/OpenZeppelin/tron-contracts/pull/54))
  ...
  - TIP-1155 is functionally identical to EIP-1155 — **including the
    ...
    kept verbatim per the TIP-1155 spec; only the receiver _interface name_
...
- Fix `BridgeTRC20` release path for false-on-success tokens (e.g. TRON USDT). ([#108](https://github.com/OpenZeppelin/tron-contracts/pull/108))
  ...
  _successful_ transfer. Because locking (`_onSend` -> `safeTransferFrom`) keeps
...
- Skip ERC2771Forwarder OOG-bubbling tests on TVM where the contract ([#58](https://github.com/OpenZeppelin/tron-contracts/pull/58))
