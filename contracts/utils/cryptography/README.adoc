 ...
 * {TIP712}: Contract with functions to allow processing signed typed structure data according to https://github.com/tronprotocol/tips/blob/master/tip-712.md[TIP-712] (the TRON-side analogue of https://eips.ethereum.org/EIPS/eip-712[EIP-712]).
