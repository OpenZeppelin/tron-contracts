...
// OpenZeppelin Tron Contracts (last updated v5.6.0) (token/TRC20/extensions/TRC20FlashMint.sol)

pragma solidity ^0.8.20;

import {ITRC3156FlashBorrower} from "../../../interfaces/ITRC3156FlashBorrower.sol";
import {ITRC3156FlashLender} from "../../../interfaces/ITRC3156FlashLender.sol";
 ...
 *
 * NOTE: When this extension is used along with the {TRC20Capped} or {TRC20Votes} extensions,
...
abstract contract TRC20FlashMint is TRC20, ITRC3156FlashLender {
     ...
     * added by other extensions, such as {TRC20Capped}. If necessary,
