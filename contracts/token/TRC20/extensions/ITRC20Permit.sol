...
// OpenZeppelin Tron Contracts (last updated v5.5.0) (token/TRC20/extensions/ITRC20Permit.sol)

pragma solidity >=0.4.16;

/**
 * @dev Interface of the TRC-20 Permit extension allowing approvals to be made via signatures, as defined in
