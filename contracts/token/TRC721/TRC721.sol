...
// OpenZeppelin Tron Contracts (last updated v5.6.0) (token/TRC721/TRC721.sol)

pragma solidity ^0.8.24;

import {ITRC721} from "./ITRC721.sol";
import {ITRC721Metadata} from "./extensions/ITRC721Metadata.sol";
 ...
 * https://github.com/tronprotocol/tips/blob/master/tip-721.md[TIP-721] (the TRON-side analogue
 * of https://eips.ethereum.org/EIPS/eip-721[EIP-721]), including
...
abstract contract TRC721 is Context, TRC165, ITRC721, ITRC721Metadata, ITRC721Errors {
     ...
     * core TRC-721 logic MUST be matched with the use of {_increaseBalance} to keep balances
     ...
     * are aware of the TRC-721 standard to prevent tokens from being forever locked.
     *
     * `data` is additional data, it has no specified format and it is sent in call to `to`.
     *
     * This internal function is like {safeTransferFrom} in the sense that it invokes
     * {ITRC721Receiver-onTRC721Received} on the receiver, and can be used to e.g.
    ...
    /**
     * @dev Same as {xref-TRC721-_safeTransfer-address-address-uint256-}[`_safeTransfer`], with an additional `data` parameter which is
     * forwarded in {ITRC721Receiver-onTRC721Received} to contract recipients.
     */
    ...
    function _setApprovalForAll(address owner, address operator, bool approved) internal virtual {
        if (owner == address(0)) {
            revert TRC721InvalidApprover(address(0));
        }
