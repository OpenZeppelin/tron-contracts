...
// OpenZeppelin Tron Contracts (last updated v5.6.0) (metatx/TRC2771Forwarder.sol)
...
contract TRC2771Forwarder is TIP712, Nonces {
     ...
     */
    error TRC2771ForwarderNoRefundReceiver();
     ...
     * carrying value (since there is no receiver to refund the leftover TRX to).
     *
     * Requirements:
     *
    ...
    function executeBatch(
        ...
        if (refundValue != 0) {
            if (requireValidRequests) revert TRC2771ForwarderNoRefundReceiver();
