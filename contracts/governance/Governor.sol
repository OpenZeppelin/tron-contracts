...
// OpenZeppelin Tron Contracts (last updated v5.6.0) (governance/Governor.sol)
...
abstract contract Governor is Context, TRC165, TIP712, Nonces, IGovernor, ITRC721Receiver, ITRC1155Receiver {
    ...
    /**
     * @dev See {ITRC1155Receiver-onERC1155Received}.
     * Receiving tokens is disabled if the governance executor is other than the governor itself (eg. when using with a timelock).
     */
    ...
    /**
     * @dev See {ITRC1155Receiver-onERC1155BatchReceived}.
     * Receiving tokens is disabled if the governance executor is other than the governor itself (eg. when using with a timelock).
     */
