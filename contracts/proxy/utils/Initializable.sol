...
// OpenZeppelin Tron Contracts (last updated v5.3.0) (proxy/utils/Initializable.sol)
 ...
 * ```solidity
 * contract MyToken is TRC20Upgradeable {
 *     function initialize() initializer public {
 *         __TRC20_init("MyToken", "MTK");
 *     }
 * }
 *
 * contract MyTokenV2 is MyToken, TRC20PermitUpgradeable {
 *     function initializeV2() reinitializer(2) public {
 *         __TRC20Permit_init("MyToken");
 *     }
 * }
 * ```
 *
 * TIP: To avoid leaving the proxy in an uninitialized state, the initializer function should be called as early as
 * possible by providing the encoded function call as the `_data` argument to {TRC1967Proxy-constructor}.
 *
