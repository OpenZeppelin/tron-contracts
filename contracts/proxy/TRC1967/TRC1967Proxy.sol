...
// OpenZeppelin Tron Contracts (last updated v5.6.0) (proxy/TRC1967/TRC1967Proxy.sol)
 ...
 * https://github.com/tronprotocol/tips/blob/master/tip-1967.md[TIP-1967] (the TRON-side analogue of https://eips.ethereum.org/EIPS/eip-1967[EIP-1967]), so that it doesn't conflict with the storage layout of the
 * implementation behind the proxy.
 */
contract TRC1967Proxy is Proxy {
    /**
     * @dev The proxy is left uninitialized.
     */
    error TRC1967ProxyUninitialized();
    ...
    constructor(address implementation, bytes memory _data) payable {
        if (!_unsafeAllowUninitialized() && _data.length == 0) {
            revert TRC1967ProxyUninitialized();
        }
        TRC1967Utils.upgradeToAndCall(implementation, _data);
    }
    ...
    function _implementation() internal view virtual override returns (address) {
        return TRC1967Utils.getImplementation();
    }
