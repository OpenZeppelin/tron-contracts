...
// OpenZeppelin Tron Contracts (last updated v5.7.0-rc.0) (interfaces/ITRC6909.sol)
...
interface ITRC6909 is ITRC165 {
     ...
     * Must return true.
     *
     * WARNING: This function is subject to the same race condition risks as {ITRC20-approve}.
...
/**
 * @dev Optional extension of {ITRC6909} that adds metadata functions.
 */
interface ITRC6909Metadata is ITRC6909 {
    /**
...
/**
 * @dev Optional extension of {ITRC6909} that adds content URI functions.
 */
interface ITRC6909ContentURI is ITRC6909 {
    /**
...
/**
 * @dev Optional extension of {ITRC6909} that adds a token supply function.
 */
interface ITRC6909TokenSupply is ITRC6909 {
    /**
