...
These parameters are specified in the unit defined in the token's clock. Assuming the token uses block numbers, and assuming TRON's block time of around 3 seconds, we will have set votingDelay = 1 day = 28800 blocks, and votingPeriod = 1 week = 201600 blocks.
