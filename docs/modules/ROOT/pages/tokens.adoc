...
You've probably heard of the TRC-20 or TRC-721 token standards, and that's why you're here. Head to our specialized guides to learn more about these:

 * xref:erc20.adoc[TRC-20]: the most widespread token standard for fungible assets, albeit somewhat limited by its simplicity.
