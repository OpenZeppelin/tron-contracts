...
<<<<<<< HEAD
You've probably heard of the ERC-20 or TRC-721 token standards, and that's why you're here. Head to our specialized guides to learn more about these:

 * xref:erc20.adoc[ERC-20]: the most widespread token standard for fungible assets, albeit somewhat limited by its simplicity.
 * xref:trc721.adoc[TRC-721]: the de-facto solution for non-fungible tokens, often used for collectibles and games.
=======
You've probably heard of the TRC-20 or ERC-721 token standards, and that's why you're here. Head to our specialized guides to learn more about these:

 * xref:trc20.adoc[TRC-20]: the most widespread token standard for fungible assets, albeit somewhat limited by its simplicity.
 * xref:erc721.adoc[ERC-721]: the de-facto solution for non-fungible tokens, often used for collectibles and games.
>>>>>>> 9ed15ee47385a93cc6c8d7a8b1ee6ad9e35ad00b
