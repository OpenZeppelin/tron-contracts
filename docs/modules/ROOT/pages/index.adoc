 ...
 * Implementations of standards like xref:erc20.adoc[ERC20] and xref:trc721.adoc[TRC721].
...
* xref:tokens.adoc[Tokens]: create tradable assets or collectibles, like the well known xref:erc20.adoc[ERC20] and xref:trc721.adoc[TRC721] standards.
