...
TIP: ERC-1155 draws ideas from all of xref:trc20.adoc[TRC-20], xref:erc721.adoc[ERC-721], and https://eips.ethereum.org/EIPS/eip-777[ERC-777]. If you're unfamiliar with those standards, head to their guides before moving on.
