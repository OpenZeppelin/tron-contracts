...
TIP: ERC-1155 draws ideas from all of xref:erc20.adoc[ERC-20], xref:trc721.adoc[TRC-721], and https://eips.ethereum.org/EIPS/eip-777[ERC-777]. If you're unfamiliar with those standards, head to their guides before moving on.
