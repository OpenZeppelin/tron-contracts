...
function shouldBehaveLikeBridgeTRC1155({ chainAIsCustodial = false, chainBIsCustodial = false } = {}) {
  describe('bridge TRC1155 like', function () {
    beforeEach(function () {
      // helper
    ...
    describe('crosschain send with data', function () {
      beforeEach(async function () {
        this.receiver = await ethers.deployContract('$TRC1155ReceiverMock', [
    ...
    describe('invalid transfer', function () {
      it('missing allowance', async function () {
        ...
        await expect(
          ...
          .to.be.revertedWithCustomError(this.tokenA, 'TRC1155MissingApprovalForAll')
      ...
      it('insufficient balance', async function () {
        ...
        await expect(
          ...
          .to.be.revertedWithCustomError(this.tokenA, 'TRC1155InsufficientBalance')
    ...
    describe('restrictions', function () {
      it('only gateway can relay messages', async function () {
        ...
        await expect(
          ...
          .to.be.revertedWithCustomError(this.bridgeA, 'TRC7786RecipientUnauthorizedGateway')
    ...
    describe('reconfiguration', function () {
      it('updating a link emits an event', async function () {
        const newGateway = await ethers.deployContract('$TRC7786GatewayMock');
